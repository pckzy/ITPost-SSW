...
function rejectPost(btnElement) {
    ...
    function toggleTable() {
        ...
        if (tableDiv.classList.contains('max-h-0')) {
            tableDiv.classList.remove('max-h-0')
            tableDiv.classList.add('max-h-[1000px]')
        } else {
            tableDiv.classList.add('max-h-0')
            tableDiv.classList.remove('max-h-[1000px]')
        }
    }
    ...
    function togglePostApprove() {
        ...
        if (postApproveDiv.classList.contains('max-h-0')) {
            ...
            postApproveDiv.classList.add('max-h-[1000px]')
        } else {
            postApproveDiv.classList.add('max-h-0')
            postApproveDiv.classList.remove('max-h-[1000px]')
        }
    }
